...
(function () {
    ...
    lang["bannerList"] = {
        title: "广告管理", name: "广告", append: "添加广告",notAllowEmpty:"标题不能为空", confirmDelete: "确定删除当前广告吗？", deleteSuccess: "删除广告成功！"
    }
    lang["materialList"] = {
        title: "食材管理", name: "食材", append: "添加食材", saveFail: "保存失败！", notAllowEmpty: "标题不能为空", confirmDelete: "确定删除当前食材吗？", deleteSuccess: "删除食材成功！"
    }
    lang["articleList"] = {
        title: "文章管理", name: "文章", append: "添加文章", saveFail: "保存失败！",deleteFail:"删除失败！", notAllowEmpty: "标题不能为空", confirmDelete: "确定删除当前文章吗？", deleteSuccess: "删除文章成功！"
    }
    lang["memberList"] = {
        title: "会员管理", name: "会员", append: "添加会员", saveFail: "保存失败！", deleteFail: "删除失败！", notAllowEmpty: "标题不能为空", confirmDelete: "确定删除当前会员吗？", deleteSuccess: "删除会员成功！"
    }
